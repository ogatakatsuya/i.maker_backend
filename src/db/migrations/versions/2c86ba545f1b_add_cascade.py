...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'groups', 'quiz_sets', ['quiz_set_id'], ['id'], ondelete='CASCADE')
    op.drop_constraint('questions_ibfk_1', 'questions', type_='foreignkey')
    op.create_foreign_key(None, 'questions', 'quiz_sets', ['quiz_set_id'], ['id'], ondelete='CASCADE')
...
def downgrade() -> None:
    ...
    op.create_foreign_key('questions_ibfk_1', 'questions', 'quiz_sets', ['quiz_set_id'], ['id'])
    op.drop_constraint(None, 'groups', type_='foreignkey')
    op.create_foreign_key('groups_ibfk_1', 'groups', 'quiz_sets', ['quiz_set_id'], ['id'])
