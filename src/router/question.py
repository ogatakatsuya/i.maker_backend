...
async def add_question(quiz_set_id: int, question: AddQuestionRequest, db: AsyncSession = Depends(get_db)):
    await question_service.add_question(db, quiz_set_id, question.content, question.hint, question.answers)
